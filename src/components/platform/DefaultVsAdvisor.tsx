...
export default function DefaultVsAdvisor() {
  ...
  return (
    <div dir="rtl" className="rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl md:p-10">
      {/* Controls */}
      <div className="grid gap-8 md:grid-cols-2">
        <div>
          <div className="mb-3 flex items-baseline justify-between">
            <label className="text-sm font-bold text-slate-700">סכום המשכנתא</label>
        ...
        <div>
          <div className="mb-3 flex items-baseline justify-between">
            <label className="text-sm font-bold text-slate-700">תקופה</label>
            <span className="text-xl font-black text-slate-900">{years} שנים</span>
          </div>
          <Slider
            value={[years]}
      ...
      <div className="mt-10 grid gap-5 lg:grid-cols-[1fr_auto_1fr] lg:items-stretch">
        ...
        <div className="rounded-2xl border-2 border-slate-200 bg-slate-50 p-6">
          <div className="mb-4 flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-slate-300">
              <Building2 className="h-5 w-5 text-slate-700" />
            </div>
            <div>
              <div className="font-black text-slate-900">ברירת המחדל</div>
              <div className="text-xs text-slate-600">ההצעה הראשונה של הבנק</div>
            </div>
          </div>

          <div className="mb-5 h-4 w-full overflow-hidden rounded-full bg-slate-200">
            <div className="h-full w-full bg-gradient-to-l from-slate-400 to-slate-500" />
          </div>

          <dl className="space-y-3">
            <div className="flex items-baseline justify-between">
              <dt className="text-info text-slate-600">ריבית משוקללת</dt>
              <dd className="font-bold text-slate-900">{(DEFAULT_RATE * 100).toFixed(2)}%</dd>
            </div>
            <div className="flex items-baseline justify-between">
        ...
        {/* Optimised */}
        <div className="relative overflow-hidden rounded-2xl border-2 border-emerald-300 bg-emerald-50 p-6 shadow-lg">
          ...
          <div className="relative mb-4 flex items-center gap-3">
            ...
            <div>
              <div className="font-black text-slate-900">אחרי עבודת היועץ</div>
      ...
      <p className="mt-8 flex items-start gap-2 rounded-xl bg-slate-50 p-4 text-xs leading-relaxed text-slate-700">
