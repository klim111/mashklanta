 ...
 * `clientId` is passed on the advisor side to open a specific client's file;
 * on the client side it is omitted and the signed-in user's own file is used.
 */
export function PrincipalApproval({ clientId }: { clientId?: string }) {
  return (
    <CaseProvider clientId={clientId}>
