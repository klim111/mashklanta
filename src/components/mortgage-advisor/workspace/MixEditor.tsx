        ...
        <div className="rounded-xl border border-amber-200 bg-amber-50 p-3 space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Select value={newType} onValueChange={(value) => setNewType(value as TrackType)}>
              <SelectTrigger className="h-11 w-full bg-white text-xs sm:h-8 sm:w-[170px]">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
            ...
            <Button size="sm" className="h-11 w-full text-xs sm:h-8 sm:w-auto" onClick={() => onAddTrack(newType)}>
