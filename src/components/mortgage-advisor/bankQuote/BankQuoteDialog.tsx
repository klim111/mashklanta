    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent dir="rtl" className="flex max-h-[94vh] max-w-4xl flex-col gap-3">
        ...
        <div className="min-h-0 flex-1 space-y-3 overflow-y-auto pl-1">
          ...
          {preview ? (
            <div className="grid grid-cols-2 gap-2 rounded-xl border border-emerald-200 bg-emerald-50 p-3 sm:grid-cols-4">
              <QuoteStat
            ...
            <p className="rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 text-2xs font-semibold text-amber-800">
              {!bank
