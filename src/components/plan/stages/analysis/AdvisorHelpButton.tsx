...
/**
 * הכפתור הצף שמלווה את כל המסכים בכל חמשת השלבים.
 *
 * אין לפני השלבים שאלה אם לעשות אותם לבד או עם יועץ — מתחילים לבד, ומה שצריך
 * בכל רגע הוא הדרך להביא יועץ שיעזור בשלב: בקשת הליווי החינמית של השלב.
 */
