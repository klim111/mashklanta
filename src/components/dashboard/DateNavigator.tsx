    ...
    <>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-subtitle font-semibold text-slate-900">ניווט בזמן</h3>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-center">
            <h2 className="text-subtitle font-bold text-slate-900">
        ...
        {snapshot && (
          <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-slate-50 rounded-lg p-3">
              <p className="text-xs text-slate-600 mb-1">קרן ששולמה</p>
              <p className="text-lg font-bold text-slate-900">
                ₪{snapshot.totalPaidPrincipal.toLocaleString()}
              </p>
            </div>
            <div className="bg-slate-50 rounded-lg p-3">
              <p className="text-xs text-slate-600 mb-1">ריבית ששולמה</p>
              <p className="text-lg font-bold text-slate-900">
                ₪{snapshot.totalPaidInterest.toLocaleString()}
              </p>
            </div>
            <div className="bg-slate-50 rounded-lg p-3">
              <p className="text-xs text-slate-600 mb-1">קרן נותרת</p>
              <p className="text-lg font-bold text-slate-900">
                ₪{snapshot.totalRemainingPrincipal.toLocaleString()}
              </p>
            </div>
            <div className="bg-slate-50 rounded-lg p-3">
              <p className="text-xs text-slate-600 mb-1">תשלומים נותרים</p>
              <p className="text-lg font-bold text-slate-900">
          ...
          >
            ...
            >
              ...
              <div className="bg-blue-50 rounded-xl p-6 mb-6">
                <h4 className="font-semibold text-slate-900 mb-4">סיכום כללי</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-slate-600">סה"כ שולם</p>
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-1 text-sm">
                      <div className="flex justify-between">
                        <span className="text-slate-600">תשלומים:</span>
              ...
              {/* Track Details */}
              <div>
                <h4 className="font-semibold text-slate-900 mb-4">פירוט לפי מסלולים</h4>
