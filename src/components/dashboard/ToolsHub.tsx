...
const tools = [
  ...
  },
  {
    ...
    title: 'כלי מיחזור משכנתא',
    tag: 'שיפור תנאים במשכנתא קיימת',
    icon: RefreshCw,
    gradient: 'from-purple-500 to-fuchsia-600',
    description:
      'מזינים את מסלולי המשכנתא הקיימת ואת מועד סיום התשלומים, ורואים מה קורה להחזר החודשי ולסך הריבית בכל שינוי ריבית או תקופה.',
    benefits: [
      'החזר וסך ריבית מחושבים לפי מה שנותר לשלם בפועל, עד התאריך המדויק',
      'התרעה כשהריבית שאתם משלמים גבוהה מהממוצע במשק לפי בנק ישראל',
      'בחשבון שלכם הכלי פתוח ללא הגבלה על מספר השינויים',
    ],
  },
  {
    id: 'feasibility',
