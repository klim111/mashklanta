  ...
  const renderProperty = () => (
    ...
    >
      <div className="space-y-4 lg:col-span-2">
        ...
        <Panel demoKey="eq-calendar" title="מועד היעד לרכישה" icon={Target} hint="ממנו נגזרים מועדי התשלום המוצעים">
          <MonthCalendar
            demoKey="eq-target"
            month={targetMonth}
  ...
  const renderExpenses = () => (
    ...
    >
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          <Panel demoKey="eq-timeline" title="לוח התשלומים" icon={CalendarDays} hint="לחיצה על יום מסננת את הטבלה">
            <MonthCalendar
              demoKey="eq-payments"
          ...
          <Panel demoKey="eq-pie-chart" title="חלוקת ההון" icon={PieChart} hint="לחיצה על קטגוריה מסננת את הטבלה">
            <AllocationDonut
              slices={slices}
    ...
    return (
      ...
      >
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <div className="space-y-4">
            <Panel demoKey="eq-status" title="סטטוס התשלומים" icon={CheckCircle2}>
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          <div className="lg:col-span-2">
            <Panel demoKey="eq-export" title="ייצוא ושיתוף" icon={Download} hint="הטבלה המלאה, לשמירה או לשליחה">
  ...
  const header = (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1400px]">
        ...
        <nav className="mt-5 grid gap-2 sm:grid-cols-3" {...demoId('eq-stepper')}>
...
function Panel({
  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5" data-demo-id={demoKey}>
