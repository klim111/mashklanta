...
export const journeyStages: JourneyStage[] = [
  {
    ...
    selfServiceSteps: [
      'על השלב — מה עושים בו ומה יוצא ממנו, עם דוח לדוגמה',
      'הנכס והעסקה: כתובת, סוג עסקה, מחיר והון עצמי מול תקרת המימון',
      'מי לוקח: הכנסות, גילים, אופן העסקה, הבנק של החשבון והלוואות קיימות',
      'צפי להכנסות עתידיות, שיהפוך לפירעון מוקדם או לגרייס בתמהיל',
      'תיק המסמכים — הרשימה לפי הלווים והעסקה, והעלאה כאן או בהמשך',
      'דוח הפרופיל הפיננסי: מגבלות, סיכונים, המלצות וקווים מנחים לתמהיל — לוח בקרה אחד להורדה',
    ],
    tools: [
  ...
  },
  {
    ...
    selfServiceSteps: [
      'בשלב זה נתייחס לפרופיל הפיננסי שלכם ונבנה את המשכנתא כך שתתאים לצפי ההתפתחויות הפיננסיות והאישיות שלכם, תוך איזון בין סיכון, גמישות ויציבות המסלול, כולל התייחסות לכל השינויים הפוטנציאליים במשק ובחייכם.',
  ...
  },
  {
    ...
    advisorActions: [
      ...
      'התמחרות על בסיס התמהיל שנבנה והסלים האחידים — כדי שההשוואה תהיה אמיתית',
    ...
    selfServiceSummary:
      'ניהול סבבי ההצעות בפלטפורמה: הזנת כל הצעה מכל בנק, השוואה מול התמהיל שבניתם ולריביות שקיבלתם באישור העקרוני וחישוב מיידי של העלות הכוללת.',
    selfServiceSteps: [
      'הזנת ההצעות שהתקבלו מכל בנק',
      'השוואה מול התמהיל שבניתם והסלים האחידים שמילאתם באישור העקרוני',
  ...
  },
  {
    ...
    advisorActions: [
      ...
      'ליווי בכל סוגיה ושאלה עד החתימה הסופית והעברת הכסף, כולל פגישה מקוונת אחת עם הבנקאי',
    ],
    ...
    selfServiceSummary:
      'רשימת המסמכים שהבנק ידרוש לפי תרחיש הרכישה שלכם, והתמהיל המתומחר מהמכרז שמולו משווים את הצעת המשכנתא הסופית של הבנק.',
    selfServiceSteps: [
      'בחירת תרחיש הרכישה — יד 1 מקבלן, יד 2, מגרש, בנייה עצמית או לכל מטרה',
      'רשימת המסמכים המדויקת של אותו תרחיש, עם הדגשים ומעקב אחרי מה שכבר נאסף',
      'התמהיל המתומחר מהמכרז, מסלול מול מסלול, מול האישור הסופי של הבנק',
      'צ׳ק־ליסט חתימה ושמירת המשכנתא הסופית למעקב שוטף',
    ],
    tools: [
