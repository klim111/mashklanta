...
export const journeyStages: JourneyStage[] = [
  {
    id: 'analysis',
    number: 1,
    title: 'ניתוח פיננסי ואפיון פרופיל לקוח',
    shortTitle: 'ניתוח פיננסי',
    ...
    selfServiceSummary:
      'הפלטפורמה מריצה עבורכם את אותו ניתוח: הכנסות מול התחייבויות, יחס החזר, הון עצמי נדרש ולוח זמנים לתשלומים.',
    selfServiceSteps: [
      'הזנת הכנסות, הון עצמי והלוואות קיימות',
      'חישוב יחס החזר ו-LTV מול מגבלות בנק ישראל',
      'מפת תזרים ותכנון ההון העצמי עד יום החתימה',
      'העלאת מסמכים לתיק הדיגיטלי שלכם',
    ],
    tools: [
  ...
  },
  {
    ...
    selfServiceSummary:
      'אותם כלים בדיוק שהיועץ עובד איתם: בונה תמהיל, סלים אחידים, לוחות סילוקין מלאים והשוואה גרפית בין תרחישים.',
    selfServiceSteps: [
      'שאלון פרופיל סיכון והעדפות אישיות',
      'השוואה מול שלושת הסלים האחידים של בנק ישראל',
  ...
  },
  {
    id: 'applications',
    number: 3,
    title: 'הגשת בקשות חכמה לבנקים',
    shortTitle: 'הגשה לבנקים',
    tagline: 'תיק מבושל שמגיע לוועדת האשראי מוכן לאישור',
    icon: FileStack,
    ...
    advisorActions: [
      'הכנת התיק החיתומי המלא לכל בנק',
      'הגשה מקבילה למרכזי המשכנתאות באמצעות טופס הרשאה ייעודי',
      'התאמת רשימת המסמכים לסטטוס התעסוקתי — שכיר, עצמאי או בעל שליטה',
      'מעקב שוטף מול הבנקאים עד קבלת אישור עקרוני',
    ],
    valueHeadline: 'חיסכון בזמן וייעול בירוקרטי',
    valueDescription:
      'היועץ יודע בדיוק איזה מסמך נדרש לכל סטטוס ואיזה ניסוח עובר. במקום סבב תיקונים אינסופי מול ארבעה בנקים — תיק אחד מושלם שמוגש במקביל לכולם.',
    selfServiceSummary:
      'צ׳ק־ליסט מסמכים דינמי לפי הסטטוס שלכם, תיק דיגיטלי מסודר וזיהוי אוטומטי של מסמכים שהועלו.',
    selfServiceSteps: [
      'רשימת מסמכים מותאמת לשכיר / עצמאי / בעל שליטה',
      'העלאה וסריקה חכמה של מסמכים לתיק',
      'מעקב סטטוס מול כל בנק במקביל',
      'התראות על מסמכים חסרים או שפג תוקפם',
    ],
    tools: [
  ...
  },
  {
    id: 'auction',
    number: 4,
    title: 'ביצוע מכרז ריביות (התמחרות)',
    ...
    advisorActions: [
      ...
      'התמחרות על בסיס אותו תמהיל מדויק — כדי שההשוואה תהיה אמיתית',
    ...
    selfServiceSummary:
      'ניהול סבבי ההצעות בפלטפורמה: הזנת כל הצעה מכל בנק, השוואה על אותו בסיס וחישוב מיידי של העלות הכוללת.',
    selfServiceSteps: [
      'הזנת ההצעות שהתקבלו מכל בנק',
      'השוואה גרפית של עלות כוללת, IRR והחזר חודשי',
  ...
  },
  {
    id: 'signing',
    number: 5,
    title: 'ליווי לחתימות בבנק',
    shortTitle: 'ליווי לחתימה',
