 ...
 * ואחר כך *איך* (לבד, או מסלול בליווי יועץ). בחירה בליווי הופכת לבקשת
 ...
 * מיחזור: עצמאי / היברידי (מתחילים לבד, ובכל שלב אפשר להעביר ליועץ) ומסלול בליווי.
...
export const SERVICE_LABELS: Record<ServiceType, { title: string; description: string }> = {
  ...
  FULL: {
    title: 'מסלול בליווי',
    description: 'יועץ משכנתאות מקצועי מלווה אתכם בשלבים שתבחרו, משלב אחד ועד כל שלבי התכנון',
  },
  GUIDANCE: {
    title: 'ייעוץ והכוונה',
 ...
 * מחיר קבוע, והמחיר הסופי נקבע לפי השלבים ומורכבות התיק.
 */
export const FULL_SERVICE_PRICE = 6000;

/**
 * המסלול בליווי כפי שהלקוח רואה אותו — בלי מחיר. נוסח אחד לעמוד התמחור, לעמוד
 * הבית, ל"איך זה עובד" ולבחירת המסלול.
 */
export const ADVISORY_TRACK = {
  title: 'מסלול בליווי',
  tagline: 'משלב 1 ועד כל שלבי תכנון המשכנתא, בליווי יועץ משכנתאות מקצועי',
  priceLabel: 'מחיר לפי השלבים והתיק',
...
export const PRICING_PRINCIPLES: Array<{ id: string; title: string; description: string }> = [
  ...
  },
  {
    ...
    description:
      'מה ששילמתם על הפלטפורמה תמיד מקוזז ממחיר הליווי, ברגע שמזמינים לפחות שלב אחד עם יועץ.',
  },
  {
    id: 'included',
    title: 'כל הזמנת ליווי כוללת גישה מלאה לפלטפורמה',
    description:
      'ליווי לשלב בודד, לכמה שלבים או לכל שלבי התכנון — הגישה לכל הכלים כלולה.',
  },
  {
    id: 'freedom',
    title: 'בכל שלב בוחרים מחדש',
    description:
      'לבד, או עם יועץ משלב אחד ועד כל השלבים — ההחלטה פתוחה בכל נקודה בתהליך.',
  },
  {
    id: 'lowest',
    title: 'ליווי שתמיד זול מהממוצע בשוק',
    description:
