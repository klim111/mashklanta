...
export async function parseMortgageDocumentWithOpenAI(
  ...
  try {
    ...
    const cleanedData: MortgageDocumentData = {
      ...
      loanAmount: typeof parsedData.loanAmount === 'number' ? parsedData.loanAmount : null,
      interestRate: typeof parsedData.interestRate === 'number' ? parsedData.interestRate : null,
      loanPeriod: typeof parsedData.loanPeriod === 'number' ? parsedData.loanPeriod : null,
      monthlyPayment: typeof parsedData.monthlyPayment === 'number' ? parsedData.monthlyPayment : null,
      ltv: typeof parsedData.ltv === 'number' ? parsedData.ltv : null,
      fees: typeof parsedData.fees === 'number' ? parsedData.fees : null,
