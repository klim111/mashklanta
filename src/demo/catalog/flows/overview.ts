...
const flow: DemoFlow = {
  ...
  steps: [
    ...
    },
    {
      id: 'start',
      title: 'מה תרצו לעשות?',
      caption: 'כשמבינים את המצב בוחרים מטרה — משכנתא חדשה, מיחזור או ייעוץ — וכמה ליווי רוצים בדרך: לבד, או מסלול בליווי יועץ משלב אחד ועד כל השלבים.',
    ...
    },
    {
      id: 'pricing',
      title: 'תמחור שקוף',
      caption: 'משלמים רק על מה שלקחתם: גישה לפלטפורמה לתהליך, וליווי שמחירו נקבע לפי השלבים ומורכבות התיק — תמיד מתחת לממוצע בשוק.',
